...
if __name__ == '__main__':
    ...
    #nlu = BERTNLU(mode='sys', config_file='multiwoz_sys_context.json',model_file='https://convlab.blob.core.windows.net/convlab-2/bert_multiwoz_all_context.zip')
    nlu = BERTNLU(mode='sys', config_file='multiwoz_all.json',model_file='https://convlab.blob.core.windows.net/convlab-2/bert_multiwoz_all.zip')
